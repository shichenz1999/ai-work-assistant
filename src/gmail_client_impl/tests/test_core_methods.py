...
class TestGmailClientCoreMethods:
    ...
    def test_delete_message_logs_warning_when_message_missing(self) -> None:
        """Test delete_message logs warning when message details cannot be loaded."""
        # ARRANGE
        message_id = "test_msg_456"
        self.client.get_message = Mock(side_effect=ValueError("Missing message"))  # type: ignore[method-assign]
